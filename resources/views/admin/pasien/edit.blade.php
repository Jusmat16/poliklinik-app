            ...
            <form action="{{ route('pasien.update', $pasien->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $pasien->nama) }}"
                            placeholder="Masukkan nama pasien..." class="w-full px-4 py-2 rounded-lg 
                ...
                <div class="flex gap-3">
                    <button type="submit" class="inline-flex items-center gap-2 px-6 py-2.5
                               bg-[#2d4499] hover:bg-[#2d4499]/90
                               text-white border-2 rounded-lg p-2 font-semibold text-sm transition">
                        <i class="fas fa-save text-sm"></i>
                        Update
                    </button>

                    <a href="{{ route('pasien.index') }}" class="px-6 py-2.5 rounded-lg bg-slate-100 
